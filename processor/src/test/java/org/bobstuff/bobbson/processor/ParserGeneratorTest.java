...
//  //    var analysis =
//  //        new Analysis(Tools.types(), Tools.elements(), new BobMessager(Tools.messager(),
// false));
...
// "age".getBytes(java.nio.charset.StandardCharsets.UTF_8);
//                    """,
...
//        reader.skipValue();
//      }
//      if (!readAllValues && setDoubleCheck && setCheck && mapDoubleCheck && listCheck &&
// listDoubleCheck && mapCheck) {
//        reader.skipContext();
//        break;
//      }
//                        """,
...
//                                   return null;
//                                 }
//                                 org.bobstuff.bobbson.processor.ParserGeneratorTest.Sample result
// = new org.bobstuff.bobbson.processor.ParserGeneratorTest.Sample();
//                                 if (readEnvolope) {
//                                   reader.readStartDocument();
//                                 }
...
//                                 var readAllValues = false;
//                                 boolean nameCheck = false;
//                                 while ((type = reader.readBsonType()) !=
// org.bobstuff.bobbson.BsonType.END_OF_DOCUMENT) {
//                                   var range = reader.getFieldName();
//                                   if (!nameCheck && range.equalsArray(nameBytes, 417)) {
//                                     nameCheck = readAllValues ? false : true;
//                                     result.setName(converter_java_lang_String().read(reader));
...
//    var result =
// sut.generateWriterMapCode(sampleCollectionsStructInfo.attributes.get("mapDouble"));
//    assertEquals(
//        """
...
//                        org.bobstuff.bobbson.processor.ParserGeneratorTest.Sample obj, boolean
// writeEnvolope) {
//                      if (obj == null) {
//                        if (key == null) {
...
//    assertEquals(
//        """
//                         public org.bobstuff.bobbson.BobBsonConverter<java.lang.String>
// converter_java_lang_String() {
//                           if (converter_java_lang_String == null) {
//                             converter_java_lang_String =
// (org.bobstuff.bobbson.BobBsonConverter<java.lang.String>)
// bobBson.tryFindConverter(java.lang.String.class);
//                           }
...
//    assertEquals(
//        """
//                         public org.bobstuff.bobbson.BobBsonConverter<java.lang.Double>
// converter_java_lang_Double() {
//                           if (converter_java_lang_Double == null) {
//                             converter_java_lang_Double =
// (org.bobstuff.bobbson.BobBsonConverter<java.lang.Double>)
// bobBson.tryFindConverter(java.lang.Double.class);
//                           }
