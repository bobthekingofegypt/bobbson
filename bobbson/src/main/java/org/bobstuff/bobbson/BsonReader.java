...
public class BsonReader {
  ...
  public BsonReader(@NonNull ByteBuffer buffer) {
    this(buffer, new ContextStack());
  }

  public BsonReader(@NonNull ByteBuffer buffer, ContextStack contextStack) {
    this(new ByteBufferBobBsonBuffer(buffer), contextStack);
  }

  public BsonReader(@NonNull BobBsonBuffer buffer) {
    this(buffer, new ContextStack());
  }

  public BsonReader(@NonNull BobBsonBuffer buffer, ContextStack contextStack) {
