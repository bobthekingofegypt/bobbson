...
import static org.bobstuff.bobbson.models.Decimal128.*;
...
public class Decimal128Test {
  ...
  public void shouldHaveCorrectConstants() {
    ...
    assertEquals(
        fromIEEE754BIDEncoding(0x7800000000000000L, 0x0000000000000000L), POSITIVE_INFINITY);
    assertEquals(
        fromIEEE754BIDEncoding(0xf800000000000000L, 0x0000000000000000L), NEGATIVE_INFINITY);
  ...
  public void shouldConstructFromSimpleString() {
    ...
    assertEquals(
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x002bdc545d6b4b87L),
        parse("12345678901234567"));
    assertEquals(
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x000000e67a93c822L), parse("989898983458"));
    assertEquals(
        fromIEEE754BIDEncoding(0xb040000000000000L, 0x002bdc545d6b4b87L),
        parse("-12345678901234567"));
    assertEquals(
        fromIEEE754BIDEncoding(0x3036000000000000L, 0x0000000000003039L), parse("0.12345"));
    assertEquals(
        fromIEEE754BIDEncoding(0x3032000000000000L, 0x0000000000003039L), parse("0.0012345"));
    assertEquals(
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x002bdc545d6b4b87L),
        parse("00012345678901234567"));
  }
  ...
  public void shouldRoundExactly() {
    ...
    assertEquals(
        parse("1.234567890123456789012345678901234"),
        parse("1.2345678901234567890123456789012340"));
    assertEquals(
        parse("1.234567890123456789012345678901234"),
        parse("1.23456789012345678901234567890123400"));
    assertEquals(
        parse("1.234567890123456789012345678901234"),
        parse("1.234567890123456789012345678901234000"));
  }
  ...
  public void shouldConstructFromLong() {
    // expect
    assertEquals(
        new org.bson.types.Decimal128(new BigDecimal("1")), new org.bson.types.Decimal128(1L));
    assertEquals(
        new org.bson.types.Decimal128(new BigDecimal(Long.MIN_VALUE)),
        new org.bson.types.Decimal128(Long.MIN_VALUE));
    assertEquals(
        new org.bson.types.Decimal128(new BigDecimal(Long.MAX_VALUE)),
        new org.bson.types.Decimal128(Long.MAX_VALUE));
  }
  ...
  public void shouldConstructFromLargeBigDecimal() {
    // expect
    assertEquals(
        fromIEEE754BIDEncoding(0x304000000000029dL, 0x42da3a76f9e0d979L),
        parse("12345689012345789012345"));
    assertEquals(
        fromIEEE754BIDEncoding(0x30403cde6fff9732L, 0xde825cd07e96aff2L),
        parse("1234567890123456789012345678901234"));
    assertEquals(
        fromIEEE754BIDEncoding(0x5fffed09bead87c0L, 0x378d8e63ffffffffL),
        parse("9.999999999999999999999999999999999E+6144"));
    assertEquals(
        fromIEEE754BIDEncoding(0x0001ed09bead87c0L, 0x378d8e63ffffffffL),
        parse("9.999999999999999999999999999999999E-6143"));
    assertEquals(
        fromIEEE754BIDEncoding(0x3040ffffffffffffL, 0xffffffffffffffffL),
        parse("5.192296858534827628530496329220095E+33"));
  }
  ...
  public void shouldConvertToSimpleBigDecimal() {
    ...
    assertEquals(
        new BigDecimal("0"),
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x0000000000000000L).bigDecimalValue());
    assertEquals(
        new BigDecimal("1"),
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x0000000000000001L).bigDecimalValue());
    assertEquals(
        new BigDecimal("-1"),
        fromIEEE754BIDEncoding(0xb040000000000000L, 0x0000000000000001L).bigDecimalValue());
    assertEquals(
        new BigDecimal("12345678901234567"),
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x002bdc545d6b4b87L).bigDecimalValue());
    assertEquals(
        new BigDecimal("989898983458"),
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x000000e67a93c822L).bigDecimalValue());
    assertEquals(
        new BigDecimal("-12345678901234567"),
        fromIEEE754BIDEncoding(0xb040000000000000L, 0x002bdc545d6b4b87L).bigDecimalValue());
    assertEquals(
        new BigDecimal("0.12345"),
        fromIEEE754BIDEncoding(0x3036000000000000L, 0x0000000000003039L).bigDecimalValue());
    assertEquals(
        new BigDecimal("0.0012345"),
        fromIEEE754BIDEncoding(0x3032000000000000L, 0x0000000000003039L).bigDecimalValue());
    assertEquals(
        new BigDecimal("00012345678901234567"),
        fromIEEE754BIDEncoding(0x3040000000000000L, 0x002bdc545d6b4b87L).bigDecimalValue());
  }
  ...
  public void shouldConvertInvalidRepresentationsOfZeroAsBigDecimalZero() {
    // expect
    assertEquals(
        new BigDecimal("0"), fromIEEE754BIDEncoding(0x6C10000000000000L, 0x0).bigDecimalValue());
    assertEquals(
        new BigDecimal("0E+3"),
        fromIEEE754BIDEncoding(0x6C11FFFFFFFFFFFFL, 0xffffffffffffffffL).bigDecimalValue());
  }
  ...
  public void shouldNotConvertNaNToBigDecimal() {
    // when
    Assertions.assertThrows(ArithmeticException.class, () -> NaN.bigDecimalValue());
  }
  ...
  public void shouldConvertInvalidRepresentationsOfZeroToString() {
    // expect
    assertEquals(
        "0", fromIEEE754BIDEncoding(0x6C10000000000000L, 0x0).bigDecimalValue().toString());
    assertEquals(
        "0E+3", fromIEEE754BIDEncoding(0x6C11FFFFFFFFFFFFL, 0xffffffffffffffffL).toString());
  }
  ...
  public void testHashCode() {
    // expect
    assertEquals(
        809500703, fromIEEE754BIDEncoding(0x3040000000000000L, 0x0000000000000001L).hashCode());
  }

  @Test
  public void shouldNotConvertPositiveInfinityToBigDecimal() {
    Assertions.assertThrows(ArithmeticException.class, () -> POSITIVE_INFINITY.bigDecimalValue());
  }

  @Test
  public void shouldNotConvertNegativeInfinityToBigDecimal() {
    Assertions.assertThrows(ArithmeticException.class, () -> NEGATIVE_INFINITY.bigDecimalValue());
  }
  ...
  public void shouldExtendNumber() {
    ...
    assertEquals(
        1.2345678901234568E33d, parse("1234567890123456789012345678901234").doubleValue(), 0);
