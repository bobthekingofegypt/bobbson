...
public class BsonReaderTest {
  ...
  public void testReadStartDocumentEmbeddedDoc() {
    ...
    var sut = new StackBsonReader(buffer);
    sut.readStartDocument();
    Assertions.assertEquals(BsonType.DOCUMENT, sut.readBsonType());
